class ClaudeTasker < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma:   "PLACEHOLDER_SHA256_ARM64_SONOMA"
    sha256 cellar: :any_skip_relocation, arm64_ventura:  "PLACEHOLDER_SHA256_ARM64_VENTURA"
    sha256 cellar: :any_skip_relocation, arm64_monterey: "PLACEHOLDER_SHA256_ARM64_MONTEREY"
    sha256 cellar: :any_skip_relocation, sonoma:         "PLACEHOLDER_SHA256_SONOMA"
    sha256 cellar: :any_skip_relocation, ventura:        "PLACEHOLDER_SHA256_VENTURA"
    sha256 cellar: :any_skip_relocation, monterey:       "PLACEHOLDER_SHA256_MONTEREY"
    sha256 cellar: :any_skip_relocation, x86_64_linux:   "PLACEHOLDER_SHA256_LINUX"
  end
  ...
  def post_install
    ohai "Claude Tasker has been installed!"
  ...
  test do
    system "#{bin}/claude-tasker", "--version"
    ...
    %w[gh jq git].each do |dep|
      assert_match(/#{dep}/, shell_output("command -v #{dep}"))
    end
  end
end